      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <a href="manage-issued-books.php">
            <div class="col-md-3 col-sm-3 col-xs-6">
              <div class="dashboard-box book-not-get-box">
                <i class="fa fa-recycle fa-5x"></i>
                <?php
                $sql2 = "SELECT id from tblissuedbookdetails where (ReturnStatus='' || ReturnStatus is null)";
          ...
          <a href="reg-students.php">
            <div class="col-md-3 col-sm-3 col-xs-6">
              <div class="dashboard-box reg-box">
        ...
        <div class="row">
          ...
          <a href="manage-categories.php">
            <div class="col-md-3 col-sm-3 rscol-xs-6">
              <div class="dashboard-box cat-box">
